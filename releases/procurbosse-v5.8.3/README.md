# 🏥 ProcurBosse v5.8.3 — Stable Full Release — samwise admin

**EL5 MediProcure** | Embu Level 5 Hospital | Embu County Government | Kenya

> **Status**: stable | Built: 2026-05-02 17:25 UTC
...
```cmd
cd procurbosse-v5.8.3
npm ci --ignore-scripts
npx vite build
npx electron-builder --win --x64 --config electron-builder.yml
```

Output: `dist-electron/ProcurBosse-v5.8.3-Windows-Setup.exe`
