...
export const ROLE_MATRIX: Record<string, {
  ...
  procurement_manager: {
    ...
    allowedPrefixes: ["/dashboard","/requisitions","/purchase-orders","/suppliers","/goods-received",
      "/tenders","/bid-evaluations","/contracts","/procurement-planning","/tracking-approval",
      "/vouchers","/financials","/reports","/items","/categories","/departments",
      "/scanner","/quality","/documents","/inbox","/email",
  ...
  procurement_officer: {
    ...
    allowedPrefixes: ["/dashboard","/requisitions","/purchase-orders","/suppliers",
      ...
      "/departments","/scanner","/reports","/documents","/inbox","/profile","/notifications","/tracking-approval"],
  ...
  inventory_manager: {
    ...
    allowedPrefixes: ["/dashboard","/items","/categories","/departments",
      "/goods-received","/scanner","/reports","/documents","/inbox","/profile","/notifications","/tracking-approval"],
  ...
  warehouse_officer: {
    ...
    allowedPrefixes: ["/dashboard","/goods-received","/items","/scanner",
      "/documents","/inbox","/profile","/notifications","/tracking-approval"],
    deniedPrefixes: ["/admin","/finance-workspace","/financials","/vouchers",
