...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    ...
    return (
      <div style={{ minHeight: "100vh", display: "grid" as const, placeItems: "center", background: "#f8fafc", padding: 20 }}>
        <div style={{ maxWidth: 520, width: "100%", background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 14, padding: 24, boxShadow: "0 8px 24px rgba(15,23,42,.08)" }}>
          ...
          <pre style={{ marginTop: 16, padding: 12, background: "#0f172a", color: "#e2e8f0", borderRadius: 10, overflowX: "auto" as const, fontSize: 12 }}>
            {this.state.errorMessage}
          </pre>
          <button onClick={this.reloadApp} style={{ marginTop: 16, border: "none", background: "#2563eb", color: "#fff", borderRadius: 10, padding: "10px 14px", fontWeight: 700, cursor: "pointer" as const }}>
            Reload app
          </button>
        </div>
      </div>
