...
export default function FacilitySwitcher() {
  ...
  if (!facility || userFacilities.length <= 1) {
    ...
    return (
      <div style={{ display:"flex" as const, alignItems:"center" as const, gap:5, padding:"3px 10px", borderRadius:3, background:"rgba(255,255,255,0.08)" }}>
        <Building2 style={{ width:11, height:11, color:"rgba(255,255,255,0.5)" }}/>
        <span style={{ fontSize:11, color:"rgba(255,255,255,0.6)", maxWidth:120, overflow:"hidden" as const, textOverflow:"ellipsis", whiteSpace:"nowrap" as const }}>
  ...
  return (
    <div ref={ref} style={{ position:"relative" as const }}>
      <button
        onClick={() => setOpen(v => !v)}
        style={{ display:"flex" as const, alignItems:"center" as const, gap:5, padding:"3px 10px", borderRadius:3,
        ...
        <span style={{ fontSize:11, color:"rgba(255,255,255,0.85)", fontWeight:600, maxWidth:120, overflow:"hidden" as const, textOverflow:"ellipsis", whiteSpace:"nowrap" as const }}>
          {facility.short_name}
        </span>
      ...
      {open && (
        <div style={{ position:"absolute" as const, top:"calc(100% + 4px)", left:0, minWidth:260, maxWidth:320,
          background:"#fff", borderRadius:8, boxShadow:"0 8px 32px rgba(0,0,0,0.2)",
          border:"1px solid #e2e8f0", overflow:"hidden" as const, zIndex:700 }}>
          ...
          {userFacilities.map(f => (
            <button key={f.id}
              ...
              style={{ display:"flex" as const, alignItems:"center" as const, gap:10, width:"100%", padding:"9px 12px",
                border:"none", cursor:"pointer" as const, textAlign:"left" as const,
              ...
              <div style={{ flex:1, minWidth:0 }}>
                ...
                <div style={{ display:"flex" as const, alignItems:"center" as const, gap:4, marginTop:1 }}>
