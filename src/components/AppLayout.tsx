...
const MODULES = [
  ...
  { id:"comms", label:"Communications", icon:Mail, color:"#22d3ee", path:"/email",
    roles:[] as string[],
    sub:[
      {label:"Email / Inbox",  path:"/email",         icon:Mail,          roles:[] as string[]},
      {label:"SMS",            path:"/sms",           icon:MessageSquare, roles:["admin","procurement_manager"]},
      {label:"Telephony",      path:"/telephony",     icon:Phone,         roles:["admin","procurement_manager"]},
      {label:"Notifications",  path:"/notifications", icon:Bell,          roles:[] as string[]},
      {label:"Reception",      path:"/reception",     icon:UserCircle,    roles:["admin","reception"]},
    ]},
  { id:"accountant", label:"Accountant", icon:DollarSign, color:"#10b981", path:"/accountant",
    roles:["admin","accountant","procurement_manager"],
    sub:[
      {label:"Accountant Workspace", path:"/accountant", icon:DollarSign, roles:["admin","accountant","procurement_manager"]},
    ]},
];
