...
const MODULES = [
  ...
  { id:"reception", label:"Reception", icon:Building2, color:"#0369a1",
    ...
    sub:[
      ...
      {label:"Call Log",       path:"/reception", icon:Phone,         roles:["admin","procurement_manager","inventory_manager","warehouse_officer"]},
      {label:"Send SMS",       path:"/reception", icon:MessageSquare, roles:["admin","procurement_manager","procurement_officer","accountant"]},
      {label:"WhatsApp",       path:"/reception", icon:MessageSquare, roles:["admin","procurement_manager"]},
    ]},
