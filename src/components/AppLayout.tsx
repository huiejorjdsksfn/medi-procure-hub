...
const MODULES = [
  ...
  { id:"accountant", label:"Accountant", icon:DollarSign, color:MOD_COLORS.accountant,
    ...
    sub:[
      {label:"Workspace",       path:"/accountant-workspace",          icon:BarChart3,     roles:[]},
      {label:"Invoice Matching",path:"/accountant-workspace",          icon:FileCheck,     roles:[]},
      ...
      {label:"ERP Sync",        path:"/accountant-workspace",          icon:Database,      roles:[]},
      {label:"Journal/Ledger",  path:"/vouchers/journal",              icon:BookOpen,      roles:[]},
      {label:"Quotations",      path:"/accountant-workspace",          icon:FileText,      roles:[]},
      {label:"Chart of Accounts",path:"/financials/chart-of-accounts",icon:BookOpen,      roles:[]},
      {label:"Fixed Assets",    path:"/financials/fixed-assets",       icon:Building2,     roles:[]},
      {label:"Notifications",   path:"/notifications",                 icon:Activity,      roles:[]},
    ]},
  ...
  { id:"reception", label:"Reception", icon:Building2, color:"#0369a1",
    ...
    sub:[
      ...
      {label:"Appointments",     path:"/reception",  icon:Calendar,      roles:[]},
      {label:"Telephony",        path:"/telephony",  icon:Phone,         roles:["admin","procurement_manager","procurement_officer","inventory_manager","warehouse_officer","accountant"]},
      {label:"Call History",     path:"/telephony",  icon:Phone,         roles:["admin","procurement_manager"]},
      {label:"SMS Dashboard",    path:"/sms",        icon:MessageSquare, roles:["admin","procurement_manager","procurement_officer","accountant"]},
      {label:"WhatsApp",         path:"/sms",        icon:MessageSquare, roles:["admin","procurement_manager"]},
      {label:"SMS Templates",    path:"/sms",        icon:FileText,      roles:["admin","procurement_manager"]},
    ]},
