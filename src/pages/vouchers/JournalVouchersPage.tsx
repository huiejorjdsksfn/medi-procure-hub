    ...
    <div className="p-4 space-y-4" style={{fontFamily:"'Segoe UI',system-ui"}}>
      <div className="rounded-2xl px-5 py-3 flex items-center justify-between" style={{background:"linear-gradient(90deg,#1e1b4b,#312e81)"}}>
        ...
        <div className="flex gap-2">
          ...
          {canApprove&&<button onClick={()=>setShowNew(true)} className="flex items-center gap-1.5 px-4 py-1.5 rounded-xl text-xs font-bold" style={{background:"#fff",color:"#312e81"}}><Plus className="w-3.5 h-3.5"/>New Journal</button>}
        </div>
      </div>
