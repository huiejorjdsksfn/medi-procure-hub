      ...
      <div  style={{background:"#fff",borderRadius:10,padding:"10px 14px",display:"flex" as const,gap:10,alignItems:"center" as const,marginBottom:12,boxShadow:"0 1px 4px rgba(0,0,0,0.06)",flexWrap:"wrap"}}>
        ...
        <div style={{display:"flex" as const,gap:4}}>
          {["all","active","inactive","suspended"].map(s=>(
            <button key={s} onClick={()=>setStatusFilter(s)} style={{padding:"4px 10px",borderRadius:20,fontSize:11,fontWeight:600,border:"none",cursor:"pointer" as const,textTransform:"capitalize",background:statusFilter===s?"#1a3a6b":"#f3f4f6",color:statusFilter===s?"#fff":"#6b7280"}}>
              {s}
            </button>
          ))}
        </div>
