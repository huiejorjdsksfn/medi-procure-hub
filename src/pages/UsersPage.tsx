    ...
    <div style={{minHeight:"100%",background:"#f8fafc",fontFamily:"'Inter','Segoe UI',sans-serif"}}>
      ...
      <div style={{background:"linear-gradient(135deg,#0a2558,#1a3a6b)",padding:"14px 20px",display:"flex" as const,alignItems:"center" as const,gap:12,flexWrap:"wrap" as const}}>
        ...
        <div style={{display:"flex" as const,gap:8}}>
          <button onClick={exportXLSX} style={{display:"flex" as const,alignItems:"center" as const,gap:6,padding:"8px 14px",background:"#e2e8f0",border:"1px solid rgba(255,255,255,0.2)",borderRadius:7,cursor:"pointer" as const,fontSize:12,fontWeight:700,color:"#fff"}}>
          ...
          <button onClick={load} style={{padding:"8px 10px",background:"#f1f5f9",border:"1px solid #e2e8f0",borderRadius:7,cursor:"pointer" as const,color:"rgba(255,255,255,0.6)",lineHeight:0}}>
            ...
            {[{l:"Full Name *",k:"full_name"},{l:"Email Address *",k:"email",t:"email"},{l:"Password *",k:"password",t:"password"},{l:"Phone",k:"phone"},{l:"Department",k:"department"}].map(f=>(
              <div key={f.k}>
                ...
                <div style={{position:"relative" as const}}>
                  ...
                  {f.k==="password"&&<button type="button" onClick={()=>setPwVis(v=>!v)} style={{position:"absolute" as const,right:10,top:"50%",transform:"translateY(-50%)",background:"#f8fafc",border:"none",cursor:"pointer" as const,color:"#9ca3af",lineHeight:0}}>
        ...
        <Modal title={`Edit: ${editUser.full_name}`} onClose={()=>setEditUser(null)}>
          <div style={{display:"flex" as const,flexDirection:"column" as const,gap:12}}>
            ...
            <div style={{display:"flex" as const,alignItems:"center" as const,justifyContent:"space-between" as const,padding:"10px 0",borderBottom:"1px solid #f3f4f6"}}>
              ...
              <button onClick={()=>setEditActive(v=>!v)} style={{background:"#f8fafc",border:"none",cursor:"pointer" as const,padding:0,lineHeight:0}}>
