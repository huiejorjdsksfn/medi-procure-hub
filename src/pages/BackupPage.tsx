...
function BackupInner() {
  ...
  return (
      <div style={{padding:24,maxWidth:896,margin:"0 auto",display:"flex" as const,flexDirection:"column" as const,gap:24, fontFamily:"'Segoe UI',system-ui,sans-serif", background:"transparent", minHeight:"100%" }}>
      {/* Header card */}
        ...
        <div style={{padding:20,display:"grid" as const,gridTemplateColumns:"1fr 1fr",gap:16}}>
          ...
          <div style={{gridColumn:"1/-1",paddingTop:12,borderTop:"1px solid #f3f4f6",display:"flex" as const,flexDirection:"column" as const,gap:8}}>
            ...
            <div style={{marginTop:16,display:"flex" as const,gap:12}}>
              ...
              <button style={{display:"flex" as const,alignItems:"center" as const,gap:8,padding:"8px 16px",borderRadius:10,fontSize:12,fontWeight:700,cursor:"pointer" as const,background:"#f0fdf4",color:"#15803d",border:"1px solid #86efac"}}>
                <Shield style={{width:14,height:14}}/> Verify Last Backup
              </button>
              <button style={{display:"flex" as const,alignItems:"center" as const,gap:8,padding:"8px 16px",borderRadius:10,fontSize:12,fontWeight:700,cursor:"pointer" as const,background:"#fff7ed",color:"#c2410c",border:"1px solid #fed7aa"}}>
      ...
      <div style={{borderRadius:16}}>
        <div style={{padding:"14px 20px",borderBottom:"1px solid #f3f4f6"}}>
          <h2 style={{fontSize:12,fontWeight:900,textTransform:"uppercase" as const,letterSpacing:"0.1em",color:"#4b5563",display:"flex" as const,alignItems:"center" as const,gap:8}}>
        ...
        <div style={{padding:20}}>
          ...
          <div style={{display:"flex" as const,alignItems:"center" as const,gap:12}}>
            <label style={{display:"flex" as const,alignItems:"center" as const,gap:8,padding:"10px 16px",borderRadius:10,fontSize:12,fontWeight:700,cursor:"pointer" as const,background:"#f0f9ff",border:"1px solid #bae6fd",color:"#0369a1"}}>
            ...
            <button style={{display:"flex" as const,alignItems:"center" as const,gap:8,padding:"10px 16px",borderRadius:10,fontSize:12,fontWeight:700,cursor:"pointer" as const,background:"#fef2f2",color:"#ef4444",border:"1px solid #fca5a5"}} onClick={handleRestore}>
