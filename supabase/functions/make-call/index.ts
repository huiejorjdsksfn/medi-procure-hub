/**
 * EL5 MediProcure — make-call Edge Function v6.0 PRODUCTION
...
<Response>
  ...
  <Say voice="alice" language="en-GB">Thank you for your response. Goodbye from ${escXml(HOSPITAL)}.</Say>
    ...
    console.log(`[make-call v6] Calling ${callTo} from ${FROM}`);
    ...
    console.log(`[make-call v6] ok=${ok} sid=${data.sid} err=${data.message}`);
    ...
    console.error("[make-call v6] Fatal:", e.message);
