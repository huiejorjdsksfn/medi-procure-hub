 ...
 * SMS:    MGd547d8e3273fda2d21afdd6856acb245 (Messaging Service)
 * Verify: VA692606d4faea3c18432a857f111dbfad (Verify Service — OTP only)
...
const MG_SID   = Deno.env.get("TWILIO_MESSAGING_SERVICE_SID") || "MGd547d8e3273fda2d21afdd6856acb245"; // SMS Messaging Service
