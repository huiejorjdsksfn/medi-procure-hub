...
VALUES
  ...
  ('twilio_account_sid',           'ACe96c6e0e5edd4de5f5a4c6d9cc7b7c5a', 'Twilio Account SID'),
  ('twilio_auth_token',            'd73601fbefe26e01b06e22c53a798ea6',    'Twilio Auth Token'),
  ('twilio_phone_number',          '+16812972643',                        'EL5H SMS number'),
  ('twilio_messaging_service_sid', 'MGd547d8e3273fda2d21afdd6856acb245', 'Messaging Service SID (SMS)'),
  ('twilio_verify_service_sid',    'VA692606d4faea3c18432a857f111dbfad', 'Verify Service SID (OTP)'),
